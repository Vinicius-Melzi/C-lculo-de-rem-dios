...
function calcularVolumeEsf(raio){

    return (4 * 1 / 3) * (Math.PI * raio * raio * raio)
}
...
function gi(vTan, precoRemedioMetro){
...
function principal(){
    ...
    let vEsf = calcularVolumeEsf(raio)
...
console.log(`O volume total do cilindro é: ${vCil.toFixed(2)} cm³`)
console.log(`O volume total da esfera é: ${vEsf.toFixed(2)} cm³`)
console.log(`O volume total da capsula é: ${vCap.toFixed(2)} cm³`)
